...
;389:		case K_JOY3:
;390:		case K_JOY4:
;391:			// have enter go to next cursor point
;392:			*key = K_TAB;
ADDRFP4 4
INDIRP4
CNSTI4 9
...
;394:
;395:		case K_TAB:
;396:		case K_KP_DOWNARROW:
;397:		case K_DOWNARROW:
...
line 407
;406:
;407:				if ((m->generic.flags & QMF_UPPERCASE) && Q_islower( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
LABELV $198
line 409
;409:				else if ((m->generic.flags & QMF_LOWERCASE) && Q_isupper( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
LABELV $200
line 411
;411:				else if ((m->generic.flags & QMF_NUMBERSONLY) && Q_isalpha( keycode ))
ADDRFP4 0
INDIRP4
CNSTI4 44
ADDP4
...
line 414
;413:
;414:				MField_CharEvent( &m->field, keycode);
ADDRFP4 0
INDIRP4
CNSTI4 64
ADDP4
...
line 417
;416:			else
;417:				MField_KeyDownEvent( &m->field, keycode );
ADDRFP4 0
INDIRP4
CNSTI4 64
ADDP4
