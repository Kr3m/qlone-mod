...
LABELV $156
line 183
;183:		|| trap_Cvar_VariableValue( "ui_gametype" ) == GT_SINGLE_PLAYER ) {
line 184
...
LABELV $180
line 199
;199:		|| trap_Cvar_VariableValue( "ui_gametype" ) == GT_SINGLE_PLAYER ) {
line 200
...
line 214
;213:
;214:	if( trap_Cvar_VariableValue( "ui_gametype" ) < GT_TEAM )
ADDRGP4 $154
ARGP4
ADDRLP4 4140
ADDRGP4 trap_Cvar_VariableValue
