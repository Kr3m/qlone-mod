...
;242:	int		count;
;243:
;244:	//trap_GetConfigString(CS_SERVERINFO, info, MAX_INFO_STRING);
;245:	//gametype = atoi( Info_ValueForKey( info,"g_gametype" ) );
;246:	gametype = trap_Cvar_VariableValue( "ui_gametype" );
ADDRGP4 $144
ARGP4
ADDRLP4 16
