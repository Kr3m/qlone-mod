...
;867:	// play buffered voice chats
;868:	CG_PlayBufferedVoiceChats();
;869:#endif
;870:
;871:	// finish up the rest of the refdef
;872:	if ( cg.testModelEntity.hModel ) {
ADDRGP4 cg+117956+8
INDIRI4
CNSTI4 0
EQI4 $841
...
LABELV $841
line 875
;875:	cg.refdef.time = cg.time;
ADDRGP4 cg+109056+72
ADDRGP4 cg+107604
INDIRI4
ASGNI4
line 876
;876:	memcpy( cg.refdef.areamask, cg.snap->areamask, sizeof( cg.refdef.areamask ) );
...
line 879
;877:
;878:	// warning sounds when powerup is wearing off
;879:	CG_PowerupTimerSounds();
ADDRGP4 CG_PowerupTimerSounds
CALLV
pop
line 882
;880:
;881:	// update audio positions
;882:	trap_S_Respatialize( cg.snap->ps.clientNum, cg.refdef.vieworg, cg.refdef.viewaxis, inwater );
ADDRGP4 cg+36
INDIRP4
CNSTI4 184
ADDP4
...
line 885
;883:
;884:	// make sure the lagometerSample and frame timing isn't done twice when in stereo
;885:	if ( stereoView != STEREO_RIGHT ) {
ADDRFP4 4
INDIRI4
CNSTI4 2
EQI4 $858
line 886
;886:		cg.frametime = cg.time - cg.oldTime;
ADDRGP4 cg+107600
ADDRGP4 cg+107604
INDIRI4
ADDRGP4 cg+107608
...
LABELV $863
line 890
;890:		cg.oldTime = cg.time;
ADDRGP4 cg+107608
ADDRGP4 cg+107604
INDIRI4
ASGNI4
line 891
;891:		CG_AddLagometerFrameInfo();
...
LABELV $858
line 893
;893:	if (cg_timescale.value != cg_timescaleFadeEnd.value) {
...
;899:		else {
line 900
;900:			cg_timescale.value -= cg_timescaleFadeSpeed.value * ((float)cg.frametime) / 1000;
ADDRLP4 12
ADDRGP4 cg_timescale+8
ASGNP4
ADDRLP4 12
...
ASGNF4
line 901
;901:			if (cg_timescale.value < cg_timescaleFadeEnd.value)
ADDRGP4 cg_timescale+8
INDIRF4
ADDRGP4 cg_timescaleFadeEnd+8
INDIRF4
GEF4 $889
line 902
;902:				cg_timescale.value = cg_timescaleFadeEnd.value;
ADDRGP4 cg_timescale+8
ADDRGP4 cg_timescaleFadeEnd+8
INDIRF4
ASGNF4
...
LABELV $874
line 904
;904:		if (cg_timescaleFadeSpeed.value) {
ADDRGP4 cg_timescaleFadeSpeed+8
INDIRF4
CNSTF4 0
EQF4 $895
line 905
;905:			trap_Cvar_Set("timescale", va("%f", cg_timescale.value));
ADDRGP4 $899
ARGP4
ADDRGP4 cg_timescale+8
INDIRF4
...
line 910
;908:
;909:	// actually issue the rendering calls
;910:	CG_DrawActive( stereoView );
ADDRFP4 4
INDIRI4
ARGI4
...
line 913
;911:
;912:	// this counter will be bumped for every valid scene we generate
;913:	cg.clientFrame++;
ADDRLP4 12
ADDRGP4 cg
ASGNP4
...
line 915
;914:
;915:	if ( cg_stats.integer ) {
ADDRGP4 cg_stats+12
INDIRI4
CNSTI4 0
EQI4 $901
line 916
;916:		CG_Printf( "cg.clientFrame:%i\n", cg.clientFrame );
ADDRGP4 $904
ARGP4
ADDRGP4 cg
INDIRI4
