...
;363:const int	cl_numparticles = MAX_PARTICLES;
;364:
...
;1478:*/
;1479:
;1480:void CG_ParticleExplosion( const char *animStr, const vec3_t origin, const vec3_t vel, int duration, int sizeStart, int sizeEnd )
;1481:{
line 1485
;1482:	cparticle_t	*p;
;1483:	int anim;
...
line 2069
;2067:
;2068:void CG_ParticleSparks (vec3_t org, vec3_t vel, int duration, float x, float y, float speed)
;2069:{
line 2072
;2070:	cparticle_t	*p;
;2071:
;2072:	if (!free_particles)
ADDRGP4 free_particles
INDIRP4
CVPU4 4
CNSTU4 0
...
LABELV $1627
line 2074
;2074:	p = free_particles;
ADDRLP4 0
ADDRGP4 free_particles
INDIRP4
ASGNP4
line 2075
;2075:	free_particles = p->next;
ADDRGP4 free_particles
ADDRLP4 0
INDIRP4
INDIRP4
...
line 2080
;2079:	
;2080:	p->endtime = cg.time + duration;
ADDRLP4 0
INDIRP4
CNSTI4 8
ADDP4
...
ASGNI4
line 2081
;2081:	p->startfade = cg.time + duration/2;
ADDRLP4 0
INDIRP4
CNSTI4 96
ADDP4
...
line 2092
;2091:
;2092:	p->pshader = cgs.media.tracerShader;
ADDRLP4 0
INDIRP4
CNSTI4 68
ADDP4
...
line 2105
;2104:
;2105:	p->accel[0] = p->accel[1] = p->accel[2] = 0;
ADDRLP4 24
CNSTF4 0
ASGNF4
ADDRLP4 0
...
ASGNF4
line 2109
;2109:	p->vel[2] += (20 + (crandom() * 10)) * speed;	
ADDRLP4 44
ADDRGP4 rand
CALLI4
ASGNI4
...
line 2117
;2115:
;2116:void CG_ParticleDust (centity_t *cent, vec3_t origin, vec3_t dir)
;2117:{
line 2126
;2118:	float	length;
;2119:	float	dist;
;2120:	float	crittersize;
;2121:	vec3_t	angles, forward;
;2122:	vec3_t	point;
;2123:	cparticle_t	*p;
;2124:	int		i;
;2125:	
...
pop
line 2131
;2131:	AngleVectors (angles, forward, NULL, NULL);
ADDRLP4 44
ARGP4
ADDRLP4 20
ARGP4
...
;2144:	{
line 2145
;2145:		VectorMA (point, crittersize, forward, point);	
ADDRLP4 4
ADDRLP4 4
INDIRF4
ADDRLP4 20
...
line 2150
;2149:
;2150:		p = free_particles;
ADDRLP4 0
ADDRGP4 free_particles
INDIRP4
ASGNP4
line 2151
;2151:		free_particles = p->next;
ADDRGP4 free_particles
ADDRLP4 0
INDIRP4
INDIRP4
...
line 2160
;2159:
;2160:		p->pshader = cgs.media.smokePuffShader;
ADDRLP4 0
INDIRP4
CNSTI4 68
ADDP4
...
line 2163
;2161:
;2162:		// RF, stay around for long enough to expand and dissipate naturally
;2163:		if (length)
ADDRLP4 32
INDIRF4
CNSTF4 0
EQF4 $1654
line 2164
;2164:			p->endtime = cg.time + 4500 + (crandom() * 3500);
ADDRLP4 76
ADDRGP4 rand
CALLI4
ASGNI4
...
line 2166
;2165:		else
;2166:			p->endtime = cg.time + 750 + (crandom() * 500);
ADDRLP4 80
ADDRGP4 rand
CALLI4
ASGNI4
...
line 2174
;2172:
;2173:		// RF, expand while falling
;2174:		p->endheight = LARGESIZE*3.0;
ADDRLP4 0
INDIRP4
CNSTI4 80
ADDP4
...
line 2195
;2193:
;2194:		// RF, add some gravity/randomness
;2195:		p->accel[0] = crandom()*3;
ADDRLP4 96
ADDRGP4 rand
CALLI4
ASGNI4
...
ASGNF4
line 2197
;2197:		p->accel[2] = -PARTICLE_GRAVITY*0.4;
ADDRLP4 0
INDIRP4
CNSTI4 44
ADDP4
...
line 2213
;2211:
;2212:void CG_ParticleMisc (qhandle_t pshader, vec3_t origin, int size, int duration, float alpha)
;2213:{
line 2216
;2214:	cparticle_t	*p;
;2215:
...
NEI4 $1662
line 2217
;2217:		CG_Printf ("CG_ParticleImpactSmokePuff pshader == ZERO!\n");
ADDRGP4 $1497
ARGP4
ADDRGP4 CG_Printf
CALLV
...
line 2222
;2221:
;2222:	p = free_particles;
ADDRLP4 0
ADDRGP4 free_particles
INDIRP4
ASGNP4
line 2223
;2223:	free_particles = p->next;
ADDRGP4 free_particles
ADDRLP4 0
INDIRP4
INDIRP4
...
LEI4 $1667
line 2234
;2234:		p->endtime = cg.time + duration;
ADDRLP4 0
INDIRP4
CNSTI4 8
ADDP4
