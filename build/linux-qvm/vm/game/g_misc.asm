...
;64://qlone - freezetag
;65:	if ( /*player->client->sess.sessionTeam != TEAM_SPECTATOR*/ !is_spectator( player->client ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
line 67
;66://qlone - freezetag
;67:		tent = G_TempEntity( player->client->ps.origin, EV_PLAYER_TELEPORT_OUT );
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNP4
line 68
;68:		tent->s.clientNum = player->s.clientNum;
ADDRLP4 0
INDIRP4
CNSTI4 168
ADDP4
...
line 70
;69:
;70:		tent = G_TempEntity( origin, EV_PLAYER_TELEPORT_IN );
ADDRFP4 4
INDIRP4
ARGP4
CNSTI4 42
...
line 75
;73:
;74:	// unlink to make sure it can't possibly interfere with G_KillBox
;75:	trap_UnlinkEntity( player );
ADDRFP4 0
INDIRP4
ARGP4
...
line 77
;76:
;77:	VectorCopy( origin, player->client->ps.origin );
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNB 12
line 78
;78:	player->client->ps.origin[2] += 1.0f;
ADDRLP4 8
ADDRFP4 0
INDIRP4
CNSTI4 516
...
LABELV $61
line 83
;83:	VectorScale( player->client->ps.velocity, (g_speed.value * 1.25f), player->client->ps.velocity );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
line 99
;96:
;97:	// kill anything at the destination
;98://qlone - freezetag
;99:	if ( /*player->client->sess.sessionTeam != TEAM_SPECTATOR*/ !is_spectator( player->client ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
...
line 105
;103:
;104:	// save results of pmove
;105:	BG_PlayerStateToEntityState( &player->client->ps, &player->s, qtrue );
ADDRLP4 36
ADDRFP4 0
INDIRP4
ASGNP4
...
line 108
;106:
;107:	// use the precise origin for linking
;108:	VectorCopy( player->client->ps.origin, player->r.currentOrigin );
ADDRLP4 40
ADDRFP4 0
INDIRP4
ASGNP4
...
;109:
;110://qlone - freezetag
;111:	if ( /*player->client->sess.sessionTeam != TEAM_SPECTATOR*/ !is_spectator( player->client ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 516
ADDP4
