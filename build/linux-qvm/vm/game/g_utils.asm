...
LABELV $242
line 537
;537:			if ( !hit->client && !is_body_freeze( hit ) ) continue;
ADDRLP4 0
INDIRP4
CNSTI4 516
ADDP4
...
;557:===============
;558:*/
;559:void G_AddPredictableEvent( gentity_t *ent, entity_event_t event, int eventParm ) {
line 560
;560:	if ( !ent->client ) {
ADDRFP4 0
INDIRP4
...
line 563
;562:	}
;563:	BG_AddPredictableEventToPlayerstate( event, eventParm, &ent->client->ps, -1 );
ADDRFP4 4
INDIRI4
ARGI4
ADDRFP4 8
...
NEI4 $253
line 579
;579:		G_Printf( "G_AddEvent: zero event added for entity %i\n", ent->s.number );
ADDRGP4 $255
ARGP4
ADDRFP4 0
INDIRP4
...
;581:	}
;582:
;583:	// clients need to add the event in playerState_t instead of entityState_t
;584:	if ( ent->client ) {
ADDRFP4 0
INDIRP4
CNSTI4 516
...
ASGNP4
line 586
;586:		bits = client->ps.externalEvent & EV_EVENT_BITS;
ADDRLP4 0
ADDRLP4 4
INDIRP4
CNSTI4 128
...
ASGNI4
line 587
;587:		bits = ( bits + EV_EVENT_BIT1 ) & EV_EVENT_BITS;
ADDRLP4 0
ADDRLP4 0
INDIRI4
CNSTI4 256
...
ASGNI4
line 588
;588:		client->ps.externalEvent = event | bits;
ADDRLP4 4
INDIRP4
CNSTI4 128
ADDP4
...
ASGNI4
line 589
;589:		client->ps.externalEventParm = eventParm;
ADDRLP4 4
INDIRP4
CNSTI4 132
ADDP4
...
ASGNI4
line 590
;590:		client->ps.externalEventTime = level.time;
ADDRLP4 4
INDIRP4
CNSTI4 136
ADDP4
...
LABELV $256
line 592
;592:		bits = ent->s.event & EV_EVENT_BITS;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 180
...
ASGNI4
line 593
;593:		bits = ( bits + EV_EVENT_BIT1 ) & EV_EVENT_BITS;
ADDRLP4 0
ADDRLP4 0
INDIRI4
CNSTI4 256
...
;607:	gentity_t	*te;
;608:
;609:	te = G_TempEntity( ent->r.currentOrigin, EV_GENERAL_SOUND );
ADDRFP4 0
INDIRP4
CNSTI4 488
ADDP4
...
;619:G_SetOrigin
;620:
;621:Sets the pos trajectory for a fixed position
;622:================
;623:*/
;624:void G_SetOrigin( gentity_t *ent, vec3_t origin ) {
line 625
;625:	VectorCopy( origin, ent->s.pos.trBase );
ADDRFP4 0
INDIRP4
CNSTI4 24
ADDP4
...
ASGNB 12
line 626
;626:	ent->s.pos.trType = TR_STATIONARY;
ADDRFP4 0
INDIRP4
CNSTI4 12
ADDP4
...
ASGNI4
line 629
;629:	VectorClear( ent->s.pos.trDelta );
ADDRFP4 0
INDIRP4
CNSTI4 36
ADDP4
...
line 631
;630:
;631:	VectorCopy( origin, ent->r.currentOrigin );
ADDRFP4 0
INDIRP4
CNSTI4 488
ADDP4
...
;636:DebugLine
;637:
;638:  debug polygons only work when running a local game
;639:  with r_debugSurface set to 2
;640:================
;641:*/
;642:int DebugLine(vec3_t start, vec3_t end, int color) {
line 643
;643:	vec3_t points[4], dir, cross, up = {0, 0, 1};
ADDRLP4 72
ADDRGP4 $263
INDIRB
ASGNB 12
...
;652:
;653:
;654:	VectorSubtract(end, start, dir);
ADDRLP4 88
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 657
;657:	if (dot > 0.99 || dot < -0.99) VectorSet(cross, 1, 0, 0);
ADDRLP4 84
INDIRF4
CNSTF4 1065185444
GTF4 $275
...
LABELV $273
line 658
;658:	else CrossProduct(dir, up, cross);
ADDRLP4 60
ARGP4
ADDRLP4 72
ARGP4
...
line 662
;661:
;662:	VectorMA(points[0], 2, cross, points[0]);
ADDRLP4 0
ADDRLP4 0
INDIRF4
ADDRLP4 48
...
ASGNF4
line 663
;663:	VectorMA(points[1], -2, cross, points[1]);
ADDRLP4 0+12
ADDRLP4 0+12
INDIRF4
ADDRLP4 48
...
ASGNF4
line 664
;664:	VectorMA(points[2], -2, cross, points[2]);
ADDRLP4 0+24
ADDRLP4 0+24
INDIRF4
ADDRLP4 48
...
ASGNF4
line 665
;665:	VectorMA(points[3], 2, cross, points[3]);
ADDRLP4 0+36
ADDRLP4 0+36
INDIRF4
ADDRLP4 48
...
line 667
;666:
;667:	return trap_DebugPolygonCreate(color, 4, points);
ADDRFP4 8
INDIRI4
ARGI4
CNSTI4 4
